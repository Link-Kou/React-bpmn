...
export default class OrderCardboardTable extends React.Component {
    ...
    public Columns = [
        ...
        {
            HeaderCell: <HeaderCell>生产参数</HeaderCell>,
            Cell: <Cell dataKey="describe">
                {(rowData: any) => (
        ...
        },
        {
            ...
            Cell: <Cell dataKey="url">
                {(rowData: any) => (
                    <Button appearance="ghost">移除</Button>
                )}
            </Cell>,
            width: 155,
            fixed: false,
    ...
    public render() {
        return (
            <>
                <HeadPanel hideBorderBottom={true} title={'纸板订单列表'}>
